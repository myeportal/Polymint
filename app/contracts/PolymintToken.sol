...
/// @author Polymint <polymint4u@gmail.com>
/// @custom:security-contact polymint4u@gmail.com
contract PolymintToken is
    ERC721,
    ERC721URIStorage,
    Pausable,
    AccessControl,
    ERC721Burnable
{
    ...
    constructor() ERC721("Polymint", "BNM") {
        ...
        returns (uint256)
    {
        require(
            ...
            "PolymintToken: No Token URI supplied"
        );
        _tokenIds.increment();
    ...
    function destoryItem(uint256 tokenId) public whenNotPaused returns (bool) {
        require(
            _exists(tokenId),
            "PolymintToken: Burn for nonexistent token"
        );
