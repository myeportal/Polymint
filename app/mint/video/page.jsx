...
export default function MintVideo() {
  ...
  const handleUploadAndMint = async () => {
    ...
    videoFormData.append("file", uploadedVideoFile);
      ...
      <div className="px-4 py-8 min-h-screen bg-gray-50 flex flex-col items-center">
        <div className="w-full max-w-2xl bg-white shadow-lg border border-gray-200 rounded-lg p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-xl font-bold">Mint your Video as NFV</h1>
          </div>

          {/* Image Upload */}
          <p className="text-sm text-gray-600 mb-4">
            Upload the image that will represent your NFV
